...
class Position(Worker):
    def get_full_name(self):
        return print(f'Сотрудника зовут: {self.name} {self.surname}')

    def get_total_income(self):
        return print(f'Суммарный доход: {self._income_wage + self._income_bonus}')


a = Position('Иван', 'Иванов', 'Маркетолог', {'wage': 30000, 'bonus': 10000})
a.get_full_name()
